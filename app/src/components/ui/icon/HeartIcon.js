...
const HeartIcon = ({size="512px", fill="#FFFFFF"}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 512 512" width={size} height={size}>
      <g>
      	<path fill={fill} d="M256,481c-3.53,0-7.046-1.23-9.873-3.706c-21.826-19.087-42.583-36.782-62.109-53.423
        ...
        <path fill={fill} d="M265.873,477.294c21.826-19.087,42.583-36.782,62.109-53.423C438.183,329.96,512,267.909,512,177.514
